...
public class FeedParser {
    ...
    public Feed parse(InputStream is) throws FeedReadException, SAXException,
    ...
    private Feed parse(SAXParser parser, InputStream is) throws FeedReadException, SAXException, IOException {
        if (parser == null) {
