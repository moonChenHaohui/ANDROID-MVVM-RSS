...
public class TastyToast {
    ...
    private static TastyToast makeText(Activity context, CharSequence text,	Style style, View view, boolean floating, float textSize) {
        ...
        tv.setText(text);
        //动画
        ViewPropertyAnimator.animate(tv).setDuration(1000).scaleXBy(.5f).scaleYBy(.5f).setInterpolator(new AnticipateOvershootInterpolator());
        result.mView = view;
    ...
    public TastyToast setLayoutBelow(View view){
        FrameLayout.LayoutParams lp = new FrameLayout.LayoutParams(LayoutParams.MATCH_PARENT, LayoutParams.WRAP_CONTENT);
        lp.setMargins(0,view.getBottom(),0,0);
        mLayoutParams = lp;
        return this;
    }
