...
public class Article {
    ...
    public Article(Long id, String title, Integer use_count, String container, String link, java.util.Date publishtime, String rights, String uri, String creator, long feed_id) {
        this.id = id;
        this.title = title;
