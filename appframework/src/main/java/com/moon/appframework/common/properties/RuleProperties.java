...
public class RuleProperties {
  ...
  private static final String TAG = "RuleProperties";
  ...
  public RuleProperties(Context context) {
    mResources = context.getResources();
    openProperties(mResources);
  }

  public RuleProperties(Context context, String propertiesFileName) {
    mResources = context.getResources();
  ...
  protected void loadPropertiesValues() {
    Class<? extends RuleProperties> thisClass = this.getClass();
